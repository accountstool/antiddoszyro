      ...
      <Modal open={modalOpen} title={editing.id ? t("domains.edit") : t("domains.add")} onClose={() => setModalOpen(false)}>
        ...
        >
          ...
          <Field className="md:col-span-2" label={t("domains.rulesJson")}>
            <textarea
              className="min-h-48 w-full rounded-2xl border border-black/14 bg-neutral-50 px-4 py-3 text-sm font-medium text-slate-900 shadow-sm shadow-black/5 outline-none transition placeholder:text-neutral-400 focus:border-black/35 focus:bg-white focus:ring-4 focus:ring-black/8 dark:border-white/10 dark:bg-neutral-900 dark:text-slate-100 dark:placeholder:text-neutral-500 dark:focus:border-white/24 dark:focus:bg-neutral-900"
