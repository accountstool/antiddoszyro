...
func Load() Config {
	...
	return Config{
		...
		Nginx: NginxConfig{
			...
			SitesAvailable:   env("NGINX_SITES_AVAILABLE", "/etc/nginx/sites-available/shieldpanel"),
			SitesEnabled:     env("NGINX_SITES_ENABLED", "/etc/nginx/sites-enabled/shieldpanel"),
